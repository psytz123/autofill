    ...
    return (
      ...
      >
        ...
        >
          ...
          <span className="text-xs sm:text-[11px] mt-1 sm:mt-1.5 font-medium text-center w-full px-1 truncate">
            {label}
          </span>
        </div>
      </PreloadLink>
