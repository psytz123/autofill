  ...
  return (
    <div className={`${sizeClass} ${className}`}>
      ...
      >
        ...
        <path
          d="M250 100C223 130 210 170 240 190C270 210 290 160 320 145"
          stroke="white"
          strokeWidth="15"
          strokeLinecap="round"
        />
        <path
          d="M245 145C245 145 260 155 275 145C290 135 295 110 280 100C265 90 250 100 245 120C240 140 245 145 245 145Z"
          fill="white"
        />
        <path
          d="M290 110C290 110 325 110 320 145"
          stroke="white"
          strokeWidth="8"
          strokeLinecap="round"
        />
        ...
        {/* AUTOFILL Text */}
        <path
          d="M110 270L130 220H160L180 270H160L155 255H135L130 270H110ZM140 240H150L145 230L140 240Z"
          fill="white"
        />
        <path d="M185 220H205V255H240V270H185V220Z" fill="white" />
        <path
          d="M250 220H270V245H290V220H310V270H290V260H270V270H250V220Z"
          fill="white"
        />
        <path
          d="M320 220H370V235H340V235H340V240H365V255H340V255H340V270H320V220Z"
          fill="white"
        />
        ...
        {/* Blue Arc (Top) */}
        <path
          d="M160 310C220 280 280 280 340 310"
          stroke="#3B82F6"
          strokeWidth="20"
          strokeLinecap="round"
        />
        ...
        {/* Orange Arc (Bottom) */}
        <path
          d="M140 340C220 380 280 380 360 340"
          stroke="#FF6B00"
          strokeWidth="20"
          strokeLinecap="round"
        />
