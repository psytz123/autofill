  ...
  return (
    <div className="h-screen-minus-tab overflow-y-auto bg-slate-50 touch-scroll hide-scrollbar">
        ...
        <div className="flex items-center justify-between mt-3 sm:mt-4">
          ...
          <div>
            <Button
              variant="ghost"
              size="icon"
              className="rounded-full bg-autofill-navy text-white shadow-sm h-9 w-9 sm:h-10 sm:w-10"
            >
      ...
      <section className="px-3 sm:px-4 py-2 bg-white flex-1 overflow-y-auto">
        <h2 className="text-lg sm:text-xl font-bold autofill-navy mb-3 sm:mb-4">
          Which vehicles would you like to fill?
        </h2>
        ...
        {vehiclesLoading ? (
          ...
          <div className="text-center py-5 sm:py-6">
            ...
            <div className="flex justify-center">
              <Link href="/vehicles">
                <Button className="bg-[#FF7433] text-white hover:bg-orange-500 rounded-md py-2.5 sm:py-3 px-4 sm:px-5 text-sm sm:text-base">
                  Add Your Vehicle
                </Button>
              </Link>
            </div>
