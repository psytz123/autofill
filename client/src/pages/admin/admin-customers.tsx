...
export default function AdminCustomersPage() {
  ...
  const { data: customerPaymentMethods, isLoading: isLoadingPaymentMethods } =
    useQuery({
  ...
  const { data: customerLocations, isLoading: isLoadingLocations } = useQuery({
  ...
  const { data: customerSupportRequests, isLoading: isLoadingSupportRequests } =
    useQuery({
      queryKey: [
        "/admin/api/customers",
        selectedCustomerId,
  ...
  const { data: supportRequestMessages, isLoading: isLoadingMessages } =
    useQuery({
      queryKey: [
              ...
              <>
                ...
                <div className="flex items-center justify-between mt-4">
                  <div className="text-sm text-muted-foreground">
                    Showing {offset + 1} to{" "}
                    {Math.min(offset + limit, filteredCustomers?.length || 0)}{" "}
                  ...
                  <div className="flex space-x-2">
                    ...
                    <Button
                      ...
                      size="sm"
                      disabled={
                        page * limit >= (filteredCustomers?.length || 0)
                      }
                    ...
                    <Card>
                      ...
                      <CardContent className="grid grid-cols-3 gap-4">
                        ...
                        <div className="bg-muted/50 p-4 rounded-md">
                          ...
                          <p className="text-2xl font-bold">
                            ${customerDetail.total_spent?.toFixed(2) || "0.00"}
                          </p>
                        </div>
                        <div className="bg-muted/50 p-4 rounded-md">
                          <h4 className="font-medium text-sm text-muted-foreground mb-1">
                          ...
                          <p className="text-2xl font-bold">
                            $
                            {((customerDetail.total_spent || 0) * 1.2).toFixed(
                              2,
                            )}
                          </p>
                        </div>
                            ...
                            {isLoadingMessages ? (
                              ...
                              <div className="space-y-4">
                                ...
                                {(!supportRequestMessages ||
                                  supportRequestMessages.length === 0) && (
