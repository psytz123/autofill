...
const LocationSelectionScreen: React.FC<Partial<LocationScreenProps>> = ({
  navigation,
  route,
}) => {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        <Text style={styles.note}>
          Please ensure you select an accurate location for fuel delivery. Our
          driver will navigate to the exact pin location you select.
        </Text>
      </View>
