...
const OrderScreen: React.FC<OrderScreenProps> = ({ navigation }) => {
  ...
  const [selectedFuelType, setSelectedFuelType] = useState<FuelType>(FuelType.REGULAR_UNLEADED);
        ...
        <View style={styles.section}>
          ...
          {userLocations.length === 0 ? (
            <Card style={styles.emptyCard}>
              <Card.Content>
                <Text style={styles.emptyCardText}>No saved locations found</Text>
                <Button 
            ...
            <View style={styles.fuelTypeContainer}>
              <TouchableOpacity
                style={[
                  ...
                  selectedFuelType === FuelType.REGULAR_UNLEADED && styles.selectedFuelType
                ]}
                onPress={() => handleFuelTypeSelect(FuelType.REGULAR_UNLEADED)}
              >
                <Text style={styles.fuelTypeName}>Regular</Text>
                <Text style={styles.fuelTypePrice}>${fuelPrices.REGULAR_UNLEADED.toFixed(2)}/gal</Text>
              </TouchableOpacity>
              
              <TouchableOpacity
                style={[
                  styles.fuelTypeOption,
                  selectedFuelType === FuelType.PREMIUM_UNLEADED && styles.selectedFuelType
                ]}
                onPress={() => handleFuelTypeSelect(FuelType.PREMIUM_UNLEADED)}
              >
                <Text style={styles.fuelTypeName}>Premium</Text>
                <Text style={styles.fuelTypePrice}>${fuelPrices.PREMIUM_UNLEADED.toFixed(2)}/gal</Text>
              </TouchableOpacity>
              
              <TouchableOpacity
                style={[
                  styles.fuelTypeOption,
                  selectedFuelType === FuelType.DIESEL && styles.selectedFuelType
                ]}
                onPress={() => handleFuelTypeSelect(FuelType.DIESEL)}
              >
                <Text style={styles.fuelTypeName}>Diesel</Text>
                <Text style={styles.fuelTypePrice}>${fuelPrices.DIESEL.toFixed(2)}/gal</Text>
              </TouchableOpacity>
            </View>
          )}
        </View>
